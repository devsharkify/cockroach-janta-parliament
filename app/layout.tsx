...
export const metadata: Metadata = {
  ...
  description: 'Contest any of 543 Lok Sabha seats as a cockroach. Vote unlimited times. Pure satire. Pure chaos. Every Sunday at 11PM IST, a winner.',
  keywords: ['cockroach parliament', 'satire', 'india politics', 'meme election', 'CJP'],
  openGraph: {
    title: 'Cockroach Janta Parliament 🪳',
    description: '543 seats. Unlimited votes. Zero politicians. Every Sunday, a winner.',
    siteName: 'Cockroach Janta Parliament',
    locale: 'en_IN',
    type: 'website',
  },
  twitter: { card: 'summary_large_image', title: 'Cockroach Janta Parliament 🪳', description: 'Contest. Vote. Chaos. Every Sunday.' },
  themeColor: '#D4A017',
